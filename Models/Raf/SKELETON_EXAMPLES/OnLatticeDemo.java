package Models.Raf.SKELETON_EXAMPLES;
...
import static Models.Raf.SKELETON_EXAMPLES.OnLatticeDemo.*;
...
public class OnLatticeDemo extends AgentGrid2D<DemoAgentOnLattice> {//must feed agent class type
    ...
    public static void main(String[] args) {
        ...
        while(true){
            win.TickPause(200);//1/5 second pause between ticks
